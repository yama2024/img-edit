...
#### 図形の種類
- **矩形（Rectangle）**: `app.js:209-218` - 塗りつぶしと枠線が可能な長方形
- **円（Circle）**: `app.js:219-236` - 楕円も描画可能（ellipse APIを使用）
- **直線（Line）**: `app.js:237-243` - シンプルな直線
- **矢印（Arrow）**: `app.js:244-276` - 矢印の頭部付き直線
